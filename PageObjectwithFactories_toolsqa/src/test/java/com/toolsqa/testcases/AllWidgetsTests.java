...
public class AllWidgetsTests {
	...
	@Test(priority = 1, description = "To verify if date is chosen from calender.")
	...
	@Test(priority = 2, enabled=false, description = "To verify if date time is chosen from calender.")
	public void chooseDateTimeFromCalTest() {

		DatePickerPage dppage = BasePageInit.lnavPage.clickLeftNavwidgets_datepicker(true);
		dppage.chooseDateTimeFromCalender("12/22/2030 12:42");

	}
	
	@Test(priority = 3, description = "To verify if slider is moved.")
